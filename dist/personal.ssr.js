...
var __vue_scope_id__$2 = "data-v-4db573a7";
/* module identifier */

var __vue_module_identifier__$2 = "data-v-4db573a7";
/* functional template */
...
var __vue_render__$5 = function __vue_render__() {
  ...
  return _c('div', {
  ...
  }, [_vm._ssrNode("<div class=\"container-fluid\" data-v-70dbca58><div class=\"row align-items-center head-options\" data-v-70dbca58><div class=\"col-11 text-center\" data-v-70dbca58><span" + _vm._ssrStyle(null, null, {
    display: _vm.selectable ? '' : 'none'
  }) + " data-v-70dbca58>" + _vm._ssrEscape(_vm._s(_vm.selecteds.length) + " Seleccionados") + "</span></div> <div class=\"col-1 config-icon text-right\" data-v-70dbca58><i aria-hidden=\"true\" class=\"fa fa-cog\" data-v-70dbca58></i></div></div></div> "), _vm._ssrNode("<table class=\"table table-responsive-sm table-sm\" data-v-70dbca58>", "</table>", [_vm._ssrNode("<thead data-v-70dbca58>", "</thead>", [_vm.selectable ? _vm._ssrNode("<tr data-v-70dbca58>", "</tr>", [_vm._ssrNode("<th class=\"select-td \" data-v-70dbca58>", "</th>", [_c('drop-down', {
    scopedSlots: _vm._u([{
      key: "primary",
      fn: function fn() {
        return [_c('div', {
  ...
  }), _vm._v(" Deseleccionar Pagina\n                        ")])]) : _vm._e()]], 2)], 1), _vm._ssrNode(" "), _vm._ssrNode("<th" + _vm._ssrAttr("colspan", _vm.columnsSelectedsInOrder.length + (_vm.actioncolumn ? 2 : 1)) + " data-v-70dbca58>", "</th>", [_vm._t("top-options", null, {
    "selecteds": _vm.selecteds
  })], 2)], 2) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<tr data-v-70dbca58>", "</tr>", [_vm._ssrNode((_vm.selectable ? "<th class=\"select-td\" data-v-70dbca58>Seleccion</th>" : "<!---->") + " "), _vm._l(_vm.columnsSelectedsInOrder, function (column) {
    return _vm._ssrNode("<th data-v-70dbca58>", "</th>", [_vm._t("column", [[_vm._v("\n            " + _vm._s(column.name) + "\n          ")]], {
      "column": column
    })], 2);
  }), _vm._ssrNode(" " + (_vm.actioncolumn ? "<th class=\"medium-td\" data-v-70dbca58>Mas</th>" : "<!---->"))], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<tbody data-v-70dbca58>", "</tbody>", [_vm._l(_vm.items, function (item, index) {
    return _vm._ssrNode("<tr data-v-70dbca58>", "</tr>", [_vm.selectable ? _vm._ssrNode("<td class=\"select-td\" data-v-70dbca58>", "</td>", [_c('checkable-item', {
      ref: "rowselectbox",
      refInFor: true,
      attrs: {
      ...
      return _vm._ssrNode("<td data-v-70dbca58>", "</td>", [_vm._t(c.value, [_vm._t("cell", [[_vm._v("\n                " + _vm._s(_vm.interpret(item, c)) + "\n              ")]], {
        "row": item,
        "column": c,
    ...
    }), _vm._ssrNode(" "), _vm.actioncolumn ? _vm._ssrNode("<td data-v-70dbca58>", "</td>", [_vm._t("action", [_vm._v("\n            --\n          ")], {
      "item": item,
      "row": item,
      "hover": _vm.isHover(item[_vm.pkey])
    })], 2) : _vm._e()], 2);
  }), _vm._ssrNode(" " + (_vm.items.lenght == 0 ? "<tr class=\"select-td text-center\" data-v-70dbca58><td" + _vm._ssrAttr("colspan", _vm.items.lenght) + " data-v-70dbca58>No hay datos</td></tr>" : "<!---->"))], 2)], 2), _vm._ssrNode(" "), _vm._t("paginate", null, {
    "perpage": _vm.limit
...
var __vue_scope_id__$5 = "data-v-70dbca58";
/* module identifier */

var __vue_module_identifier__$5 = "data-v-70dbca58";
/* functional template */
