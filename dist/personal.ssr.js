...
var __vue_render__$6 = function __vue_render__() {
  ...
  return _c('div', {
  ...
  }, [_vm._ssrNode("<div class=\"container-fluid\" data-v-139c3b9c><div class=\"row align-items-center head-options\" data-v-139c3b9c><div class=\"col-11 text-center\" data-v-139c3b9c><span" + _vm._ssrStyle(null, null, {
    display: _vm.selectable ? '' : 'none'
  }) + " data-v-139c3b9c>" + _vm._ssrEscape(_vm._s(_vm.selecteds.length) + " Seleccionados") + "</span></div> <div class=\"col-1 config-icon text-right\" data-v-139c3b9c><i aria-hidden=\"true\" class=\"fa fa-cog\" data-v-139c3b9c></i></div></div></div> "), _vm._ssrNode("<table class=\"table table-responsive-sm table-sm\" data-v-139c3b9c>", "</table>", [_vm._ssrNode("<thead data-v-139c3b9c>", "</thead>", [_vm.selectable ? _vm._ssrNode("<tr data-v-139c3b9c>", "</tr>", [_vm._ssrNode("<th class=\"select-td \" data-v-139c3b9c>" + (_vm.haveSomeUnselected || _vm.selecteds.length == 0 ? "<button class=\"btn btn-sm\" data-v-139c3b9c><i aria-hidden=\"true\" class=\"fa fa-check-square fa-2\" data-v-139c3b9c></i></button>" : "<button class=\"btn btn-sm btn-secondary\" data-v-139c3b9c><i aria-hidden=\"true\" class=\"fa fa-check-square fa-2\" data-v-139c3b9c></i></button>") + "</th> "), _vm._ssrNode("<th" + _vm._ssrAttr("colspan", _vm.columnsSelectedsInOrder.length + (_vm.actioncolumn ? 2 : 1)) + " data-v-139c3b9c>", "</th>", [_vm._t("top-options", null, {
    "selecteds": _vm.selecteds
  }), _vm._ssrNode(" " + (_vm.selecteds.length > 0 ? "<a href=\"#\" width=\"30px\" data-v-139c3b9c>\n              csv\n            </a>" : "<!---->") + " " + (_vm.selecteds.length > 0 ? "<a href=\"#\" width=\"30px\" data-v-139c3b9c>\n              xls\n            </a>" : "<!---->"))], 2)], 2) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<tr data-v-139c3b9c>", "</tr>", [_vm._ssrNode((_vm.selectable ? "<th class=\"select-td\" data-v-139c3b9c>Seleccion</th>" : "<!---->") + " "), _vm._l(_vm.columnsSelectedsInOrder, function (column) {
    return _vm._ssrNode("<th data-v-139c3b9c>", "</th>", [_vm._t("column", [[_vm._v("\n            " + _vm._s(column.name) + "\n          ")]], {
      "column": column
    })], 2);
  }), _vm._ssrNode(" " + (_vm.actioncolumn ? "<th class=\"medium-td\" data-v-139c3b9c>Mas</th>" : "<!---->"))], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<tbody data-v-139c3b9c>", "</tbody>", [_vm._l(_vm.items, function (item) {
    return _vm._ssrNode("<tr data-v-139c3b9c>", "</tr>", [_vm.selectable ? _vm._ssrNode("<td class=\"select-td\" data-v-139c3b9c>", "</td>", [_c('checkable-item', {
      ref: "rowselectbox",
      refInFor: true,
      attrs: {
      ...
      return _vm._ssrNode("<td data-v-139c3b9c>", "</td>", [_vm._t(c.value, [_vm._t("cell", [[_vm._v("\n                " + _vm._s(_vm.interpret(item, c)) + "\n              ")]], {
        "row": item,
        "column": c,
    ...
    }), _vm._ssrNode(" "), _vm.actioncolumn ? _vm._ssrNode("<td data-v-139c3b9c>", "</td>", [_vm._t("action", [_vm._v("\n            --\n          ")], {
      "item": item,
      "row": item,
      "hover": _vm.isHover(item[_vm.pkey])
    })], 2) : _vm._e()], 2);
  }), _vm._ssrNode(" " + (_vm.items.length == 0 ? "<tr class=\"select-td text-center\" data-v-139c3b9c><td" + _vm._ssrAttr("colspan", _vm.items.length) + " data-v-139c3b9c>No hay datos</td></tr>" : "<!---->"))], 2)], 2), _vm._ssrNode(" "), _vm._t("paginate", null, {
    "perpage": _vm.limit
...
var __vue_scope_id__$6 = "data-v-139c3b9c";
/* module identifier */

var __vue_module_identifier__$6 = "data-v-139c3b9c";
/* functional template */
